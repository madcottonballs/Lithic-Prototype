...
operators:
    arithmatic:
        ...
        *"[array[integer] var_ref] $ [operator] [integer]":
            ...
            Ex: "x $ * 5" (every i32 in the array 'x' is multiplied by 5)
...
Functions:
    ...
    Data:
        ...
        sizeof([i32 | char | string | boolean]):
            ...
            Ex:
                sizeof(5)
            This example would return 4, because dwords have a byte size of 4.
        ...
        sConcat([string], [string]):
            ...
            Ex:
                sConcat("hello ", "world ", "it's a lovely day!")
            This would return the string "hello world it's a lovely day!".
        ...
        aConcat([array], [array]):
            ...
            Ex:
                aConcat([3, 2], [9, 21, 4], [2, 9])
            This would return the array [3, 2, 9, 21, 4, 2, 9].
        ...
        cast([any], [type]):
            ...
            Ex: "cast(5, string)" (where 5 is a i32, then turns into a string)
...
Control Flow:
    ...
    *"enumerate ([let statement], [let statement], [array | string])":
        ...
        Ex: 
            enumerate (let i32 i, let char v, "hello world") { ...}
        This would go character by character in "hello world". i = 0, v = 'h', then i = 1, v = 'e', etc.
    *"#[label]":
...
Types:
    ...
    *f64:
    ...
    type[array]:
        ...
        Ex: "let i32[3] x = [3, 5, 7]" (creates an array 'x' of size 3 preloaded with the numbers 3, 5, and 7)
    label:
        Named line of code.